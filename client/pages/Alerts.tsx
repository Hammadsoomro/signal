...
const recentAlerts: Alert[] = [
  {
    ...
    message: 'Your wallet balance has dropped below $10. Please add funds to continue sending SMS.',
    type: 'warning',
  ...
  },
  {
    ...
    message: 'Successfully delivered 125 SMS messages to your marketing campaign recipients.',
    type: 'success',
  ...
  },
  {
    ...
    message: 'Your account has sent 150% more SMS than usual today. Monitor for unusual activity.',
    type: 'info',
...
export default function Alerts() {
  ...
  const enabledAlertsCount = settings.filter(setting => setting.enabled).length;
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <h4 className={`font-medium ${!alert.read ? 'text-blue-900' : 'text-gray-900'}`}>
                            {alert.title}
                          </h4>
                          {!alert.read && (
