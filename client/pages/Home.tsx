  ...
  const loadDashboardData = async () => {
    try {
      ...
      setStats({
        ...
        messagesSentToday: messagesData.messages?.filter((msg: any) => {
    ...
    <DashboardLayout title="Dashboard">
      <div className="p-6">
        <div className="max-w-7xl mx-auto space-y-6">
          {/* Welcome Section */}
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Welcome back, Jaxon!</h2>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  <Link to="/buy-numbers" className="text-primary hover:underline">
                    Buy more numbers
                  </Link>
                </p>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  <Link to="/sub-accounts" className="text-primary hover:underline">
                    Create sub-account
                  </Link>
                </p>
              </CardContent>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>Your latest SMS conversations from SignalWire</CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    recentMessages.map((message: any, index: number) => (
                      <div key={index} className="flex items-center gap-4">
                        <div className={`w-2 h-2 rounded-full ${
                          ...
                          message.status === 'sent' ? 'bg-blue-500' : 'bg-gray-500'
                        }`} />
                        ...
                        <div className="text-xs text-muted-foreground">
                          {new Date(message.date_sent || message.date_created).toLocaleString()}
                        </div>
                      </div>
                    ))
                  ) : (
            ...
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>SignalWire and Database connectivity</CardDescription>
              </CardHeader>
              <CardContent>
