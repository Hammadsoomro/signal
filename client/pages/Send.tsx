...
export default function Send() {
  ...
  const messageTemplates = [
    ...
    {
      id: "promotion",
      text: "Special offer just for you! Get 20% off your next purchase.",
    },
    {
      id: "support",
      ...
      <div className="p-6 max-w-4xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Send SMS messages to individual recipients or bulk send to multiple
            contacts
          </p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {availableNumbers.length === 0 && (
              <Alert>
                ...
                <AlertDescription>
                  No purchased numbers available for sending. Please buy a phone
                  number first.
                </AlertDescription>
              </Alert>
            )}
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-muted-foreground">
                      ...
                      {Math.ceil(message.length / 160) > 1 ? " segments" : ""}
                    </span>
                  </div>
                </div>
